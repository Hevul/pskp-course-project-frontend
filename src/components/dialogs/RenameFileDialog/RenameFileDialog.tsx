...
import styles from "./RenameFileDialog.module.css";
import Button from "../../Button/Button";
import { useEntities } from "../../../contexts/EntitiesContext";
import useAxios from "../../../hooks/useAxios";
import { rename } from "../../../api/files";
...
const RenameFileDialog: FC<Props> = ({ id, oldName }) => {
  ...
  return (
    <DialogShell title="Переименование файла">
      <div>
        <InputWithLabel
